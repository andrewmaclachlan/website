...
Here we explore two previous dissertation submissions, one scoring a distinction and the other a pass. Across three sessions we progress through different parts of the thesis (list below). In each session we create a table for both previous submissions for comparison in relation to the marking scheme. At the end of the sessions students must create place their work within these tables. 

- Introduction and literature review 
  - Table headings: Problem, Aim/Question, Objectives, Literature review headings
...
-   Recommended thesis structure: [<i class="ai ai-open-materials ai-1.75x"></i>]()
...
* Water point data: https://www.waterpointdata.org/access-data/
